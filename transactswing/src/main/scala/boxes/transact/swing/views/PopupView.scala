...
import boxes.swing.BarStyleToggleButtonPainter
import boxes.swing.SwingToggleButton
...
object PopupView {
  def apply(n: Box[String], icon: Box[Option[Icon]], popupContents:JComponent)(implicit shelf: Shelf) = new PopupView(n, icon, popupContents)
  def apply(n: String = "", icon: Option[Icon] = None, popupContents:JComponent)(implicit shelf: Shelf) = new PopupView(BoxNow(n), BoxNow(icon), popupContents)
}

class PopupView(n: Box[String], icon: Box[Option[Icon]], popupContents: JComponent)(implicit shelf: Shelf) extends SwingView {
